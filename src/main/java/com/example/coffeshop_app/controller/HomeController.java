...
import com.example.coffeshop_app.entity.CartItem;
import com.example.coffeshop_app.entity.Order;
import com.example.coffeshop_app.entity.OrderDetail;
import com.example.coffeshop_app.entity.User;
import com.example.coffeshop_app.repository.OrderDetailRepository;
import com.example.coffeshop_app.service.OrderService;
...
public class HomeController {
    ...
    @PostMapping("/add")
    public String addToCart(@RequestParam String item, @RequestParam String image, @RequestParam double price,
            HttpSession session) {
        List<CartItem> cartItems = (List<CartItem>) session.getAttribute("cartItems");
        if (cartItems == null) {
            cartItems = new ArrayList<>();
    ...
    public String success(HttpSession session, Model model) {
        ...
        if (user != null) {
            ...
            // Save the cleared list back to the session (optional, as the list is already
            // in session)
            session.setAttribute("cartItems", cartItems);
